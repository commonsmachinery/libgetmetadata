...
var getMedia = function(url) {
    return Promise.props({
        ...
        var copyright, license, title, creator, identifier;
        var objects = [];
        ...
        // create copyright annotation since dA doesn't provide one
        copyright = new media.Policy(
            'Copyright ' + oembed['author_name'],
            oembed['author_name'],
            oembed['author_url'],
            media.MappingType.exactMatch,
            null
        ...
        objects.forEach(function(item) {
            item.annotations.push(copyright);
        });
